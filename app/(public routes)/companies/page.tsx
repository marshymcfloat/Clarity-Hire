...
export const metadata: Metadata = {
  ...
  description:
    "Browse companies and explore open roles published on ClarityHire.",
  alternates: {
    canonical: "/companies",
  },
  openGraph: {
    title: "ClarityHire Jobs Directory",
    description: "Browse companies and explore open roles on ClarityHire.",
